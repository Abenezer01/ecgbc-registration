...
// Mutable holder for the latest addToast callback so we can call it from outside React
let addToastCallback: ((toast: Omit<Toast, "id">) => void) | null = null;

/**
 * Show a toast imperatively from outside the React tree.
 * Usage: showToast({ variant: "success", title: "Done", description: "Saved" });
 */
...
export function ToastProvider({ children }: { children: React.ReactNode }) {
  ...
  // Update the callback whenever this render's addToast changes
  React.useEffect(() => {
