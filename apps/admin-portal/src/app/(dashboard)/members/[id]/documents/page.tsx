...
import { FolderOpen, CloudLightning, FileText, Download, Trash2, Eye, Plus, CheckCircle2, AlertTriangle, User, FileText as FileTextIcon, Users, ShieldAlert } from "lucide-react";
...
export default function DocumentsPage() {
  ...
  const tabs = [
    ...
    { id: "reports", label: "Reports", icon: <FileTextIcon />, path: `/members/${id}/reports`, visible: canViewReports },
    ...
    <>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 overflow-hidden">
        ...
        <div className="p-6 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          {/* Selam Minster Integration Card */}
